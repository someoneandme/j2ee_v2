...
import com.pugwoo.utils.Configs;
...
public class RedisConnectionManager {
	...
	private static String host = Configs.getConfig("redis.host");
	private static String port = Configs.getConfig("redis.port");
	private static String passwd = Configs.getConfig("redis.passwd");
